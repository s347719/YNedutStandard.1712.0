...
//        /*如果无法直接打开，就跳出软件列表给用户选择 */
    ...
    public static boolean isOverriedMethod(Object currentObject, String methodName, String method, Class... clazzs) {
        L.i("Info", "currentObject:" + currentObject + "  methodName:" + methodName + "   method:" + method);
        boolean tag = false;
        ...
        L.i("Info", "isOverriedMethod:" + tag);
        return tag;
    }


    public static void clearWebViewAllCache(Context context, final WebView webView) {
        try {
...
//            Log.i("Info", "path:" + paths[i-1] + "  uri:" + mUri);
    ...
    public static Queue<FileParcel> convertFile(String[] paths) throws Exception {
        ...
        L.i("Info", "isShutDown:" + (((ThreadPoolExecutor) mExecutor).isShutdown()));
        return mQueue;
    }
    ...
    public static Intent getIntentCompat(Context context, File file) {
        Intent mIntent = null;
        L.i("Info", "getIntentCompat  :" + context.getApplicationInfo().targetSdkVersion);
