package com.yineng.ynmessager.view.slidingmenu;
...
import com.yineng.ynmessager.view.slidingmenu.SlidingMenu.OnClosedListener;
import com.yineng.ynmessager.view.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	 ...
	 * specified item.
	 *
	 * @param item TagItem index to select
	 */
	...
	float distanceInfluenceForSnapDuration(float f) {
		...
		f *= 0.3f * Math.PI / 2.0f;
		// FloatMath.sin(float) method was removed from the public API in version 23
