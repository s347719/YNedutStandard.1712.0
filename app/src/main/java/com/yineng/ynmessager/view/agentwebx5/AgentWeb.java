...
import com.yineng.ynmessager.view.agentwebx5.interfae.IEventHandler;
import com.yineng.ynmessager.view.agentwebx5.interfae.IFileUploadChooser;
import com.yineng.ynmessager.view.agentwebx5.interfae.ILoader;
import com.yineng.ynmessager.view.agentwebx5.interfae.IVideo;
import com.yineng.ynmessager.view.agentwebx5.interfae.IWebLayout;
import com.yineng.ynmessager.view.agentwebx5.interfae.IndicatorController;
import com.yineng.ynmessager.view.agentwebx5.interfae.JsEntraceAccess;
import com.yineng.ynmessager.view.agentwebx5.interfae.JsInterfaceHolder;
import com.yineng.ynmessager.view.agentwebx5.interfae.WebCreator;
import com.yineng.ynmessager.view.agentwebx5.interfae.WebLifeCycle;
import com.yineng.ynmessager.view.agentwebx5.interfae.WebListenerManager;
...
import com.yineng.ynmessager.view.agentwebx5.interfae.WebSettings;
 ...
 *  github 地址： https://github.com/Justson/AgentWeb
 *
 */
public class AgentWeb {
    ...
    private void doCompat() {
        ...
        L.i("Info", "AgentWebConfig.isUseAgentWebView:" + AgentWebConfig.WEBVIEW_TYPE + "  mChromeClientCallbackManager:" + mChromeClientCallbackManager);
    ...
    private void setLoadListener(List<DownLoadResultListener> downLoadResultListeners){
        if (this.mDownloadListener == null) {
            this.mDownloadListener  = new DefaultDownLoaderImpl(mActivity, false, true,downLoadResultListeners,mDefaultMsgConfig.getDownLoadMsgConfig());
        }
    }
    ...
    private WebViewClient getClient() {
        if (!webClientHelper&&AgentWebConfig.WEBVIEW_TYPE != AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE && mWebViewClient != null) {
            ...
            return new DefaultWebClient(this,mActivity,this.mWebViewClient, this.mWebViewClientCallbackManager,webClientHelper);
        }
    }

    public void removeClient(){
        mWebListenerManager.setWebViewClient(mWebCreator.get(),null);
    }
