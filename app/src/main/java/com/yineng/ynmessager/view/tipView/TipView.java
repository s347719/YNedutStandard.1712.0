...
public class TipView extends View {
    ...
    // 窗口Item的宽度
    private int mItemWidth = dip2px(65);
    // 窗口Item的高度
    ...
    // 存储每个Item的信息
    private List<TipViewItem> mItemList = new ArrayList<>();
    // 存储每个方块
    ...
    public TipView(Context context, ViewGroup rootView, int x, int y, List<TipViewItem> mItemList) {
        super(context);
        // 设置传入过来的x轴坐标
        this.x = x;
        // 设置传入过来的y轴坐标
    ...
    public void setTipItemList(final List<TipViewItem> list) {
        mItemList.clear();
        for (TipViewItem item : list) {
    ...
    public static class Builder {
        ...
        private List<TipViewItem> mTipItemList = new ArrayList<>();
        ...
        public Builder addItem(TipViewItem tipItem) {
            mTipItemList.add(tipItem);
            return this;
        }

        public Builder addItems(List<TipViewItem> list) {
