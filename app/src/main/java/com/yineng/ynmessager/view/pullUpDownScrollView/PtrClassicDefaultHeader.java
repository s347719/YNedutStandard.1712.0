...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        progress_image.setImageDrawable(getContext().getResources().getDrawable(R.mipmap.default_ptr_rotate));
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.listview_header_hint_release));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.listview_header_hint_normal));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(R.string.listview_loading);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        progress_image.clearAnimation();
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.refresh_done));
    ...
    private String getLastUpdateTime() {
        ...
        sb.append(getContext().getString(R.string.listview_header_last_time));
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.listview_header_hint_release);
        }
    }
