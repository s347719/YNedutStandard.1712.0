...
public class RealDownLoader extends AsyncTask<Void, Integer, Integer> implements Observer {
    ...
    protected Integer doInBackground(Void... params) {
        ...
        try {
            ...
            this.e = e;//逃逸
            L.i("Info", "doInBackground   Exception:" + e.getMessage());
            // e.printStackTrace();
    ...
    protected void onPostExecute(Integer integer) {
        ...
        try {
            ...
            L.i("Info", "onPostExecute:" + integer);
    ...
    private void doCallback(Integer code) {
        ...
        L.i("Info", " doCallback  mDownLoadTask.getDownLoadResultListeners():" + mDownLoadTask.getDownLoadResultListener());
    ...
    private PendingIntent buildCancelContent(Context context, int id) {
        ...
        intentCancel.putExtra("mTAG", mDownLoadTask.getUrl());
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("com.agentweb.cancelled")) {
                try {
                    ...
                    String url = intent.getStringExtra("mTAG");
                    ...
                    L.i("Info", "size:" + mObservable.countObservers());
