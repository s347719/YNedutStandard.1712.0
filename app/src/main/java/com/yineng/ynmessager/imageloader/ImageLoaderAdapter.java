...
public class ImageLoaderAdapter extends CommonAdapter<String>
{
	...
	{
		//设置no_pic
		helper.setImageResource(R.id.id_item_image, R.mipmap.imageloader_pictures_no);
		//设置no_selected
				helper.setImageResource(R.id.id_item_select,
						R.mipmap.imageloader_picture_unselected);
		//设置图片
		...
		mImageView.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				if (mSelectedImage.contains(mDirPath + "/" + item))
				{
					...
					mSelect.setImageResource(R.mipmap.imageloader_picture_unselected);
					mImageView.setColorFilter(null);
				} else
				// 未选择该图片
				{
					mSelectedImage.add(mDirPath + "/" + item);
					mSelect.setImageResource(R.mipmap.imageloader_pictures_selected);
