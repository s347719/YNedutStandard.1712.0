 ...
 * @author
 */
public class NoticeFragmentPlatNotice extends BaseFragment implements OnItemClickListener {
    ...
    // 在当前页面使用cordova去连接网页
    private int messageType = 1;//初始化当前所属类型的时候为1代表通知公告
