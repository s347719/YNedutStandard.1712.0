...
public class DisInfoActivity extends BaseActivity implements OnClickListener,
	...
	private void init() {
		...
		mPersonNumTV = (TextView) findViewById(R.id.disInfo_txt_discussMembers);
		mAddPersonBtn = (RelativeLayout) findViewById(R.id.disInfo_rel_addMembersBtn);
		mLogoutGroupBtn = (Button) findViewById(R.id.disInfo_btn_quitDiscuss);
		mGetChatrecordBtn = (RelativeLayout) findViewById(R.id.disInfo_rel_chatMsgSearchBtn);
		mGroupNameTV = (TextView) findViewById(R.id.disInfo_txt_discussName);
		mGroupNameRL= (RelativeLayout) findViewById(R.id.disInfo_rel_discussRenameBtn);
		mGroupUserCountRL= (RelativeLayout) findViewById(R.id.disInfo_rel_discussMembers);
	...
	private void initDisGroupChatTitle() {
		if (mContactGroup != null) {
			if (mContactGroup.getSubject() != null && !TextUtils.isEmpty(mContactGroup.getSubject())) {
...
//	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.disInfo_rel_discussRenameBtn:
			...
			break;
		case R.id.disInfo_rel_addMembersBtn:
			...
			break;
		case R.id.disInfo_rel_chatMsgSearchBtn:
			...
			break;
		case R.id.disInfo_btn_quitDiscuss:
			mQuitGroupDialog.show();
			break;
		case R.id.disInfo_rel_discussMembers:
