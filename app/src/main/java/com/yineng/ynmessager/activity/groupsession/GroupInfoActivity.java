...
//				initDisGroupChatTitle();
	...
	public void findViews() {
		mGroupInfoNameTV = (TextView) findViewById(R.id.tv_disgroup_infop_title);
		mGroupInfoMemberCountTV = (TextView) findViewById(R.id.groupInfo_txt_discussMembers);
...
/*		case R.id.rl_group_info_namelayout:
			...
			break;*/
		case R.id.groupInfo_rel_fileSharedBtn:
			startActivity(new Intent(this,GroupSharedFilesActivity.class).putExtra("GroupId",mGroupId));
			break;
		case R.id.groupInfo_rel_discussMembers:
			...
			break;
		case R.id.groupInfo_rel_chatMsgSearchBtn:
			...
			break;
		case R.id.groupInfo_rel_addMembersBtn:
			if (mGroupBean == null) {
				ToastUtil.toastAlerMessageCenter(mContext, "没有权限", 1000);
				return;
			}
