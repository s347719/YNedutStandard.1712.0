...
//				Log.i("groupMessage","message:   " + msg.getMessage());
	...
	public GroupChatMsgEntity queryLastestChatMsg(String groupId)
	{
		...
		if(cur.moveToFirst())
		{
			...
			String curString = cur.getString(cur.getColumnIndex("content"));
			if (curString.length()>0){
				chat.setSpannableString(new SpannableString(curString));
			}else {
				chat.setSpannableString(new SpannableString(" "));
			}
