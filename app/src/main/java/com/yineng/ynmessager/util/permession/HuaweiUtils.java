...
public class HuaweiUtils {
     ...
     * 检测 Huawei 照相机权限
     */
    public static boolean checkCameraOpenPermession(Context context,int op) {
        final int version = Build.VERSION.SDK_INT;
        if (version >= 19) {
            return checkOp(context, op); //OP_CAMERA = 26;
        }
        return true;
    }
...
//      "com.huawei.permissionmanager.ui.SingleAppActivity");//华为权限管理，跳转到指定app的权限管理位置需要华为接口权限，未解决
            ComponentName comp = new ComponentName("com.huawei.systemmanager", "com.huawei.systemmanager.addviewmonitor.AddViewMonitorActivity");//华为权限管理
            ...
            if (RomUtils.getEmuiVersion() == 3.1) {
                ...
                //emui 3.0 的适配
                comp = new ComponentName("com.huawei.systemmanager", "com.huawei.systemmanager.addviewmonitor.AddViewMonitorActivity");
                intent.setComponent(comp);
                context.startActivity(intent);
            }
