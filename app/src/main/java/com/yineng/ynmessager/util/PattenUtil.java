...
public class PattenUtil {
    ...
    //定制手机号表达式 首位数是1，其他的是数字
    private final static Pattern isPhone = Pattern.compile("^1\\d{10}$");
     ...
     * 检查是否是图片
     */
    private final static Pattern image_check = Pattern.compile("(png|jpg|jpeg|gif)$");

    /**
     * 检查是否视频
     */
    private final static Pattern movie_check = Pattern.compile("(mp4|rmvb|mkv|mpeg|rm|wmv|3gp|avi|swf)$");

    /**
     * 检查是否音频
     */
    private final static Pattern voice_check = Pattern.compile("(mp3|flac|wma|aac|ape|ogg)$");

    /**
     * 检查是否ODC
     */
    private final static Pattern doc_check = Pattern.compile("(doc|docx)$");

    /**
     * 检查是否excel
     */
    private final static Pattern excel_check = Pattern.compile("(xls|xlsx)$");
    /**
     * 检查是否excel
     */
    private final static Pattern pdf_check = Pattern.compile("(pdf)$");
    /**
     * 检查是否excel
     */
    private final static Pattern ppt_check = Pattern.compile("(ppt)$");
    /**
     * 检查是否excel
     */
    private final static Pattern zip_check = Pattern.compile("(rar|7-zip|zip|tar|gzip|jar|iso)$");
    /**
     * 检查是否是压缩包
     * @param s
     * @return
     */
    public static boolean zipCheck(String s){return zip_check.matcher(s).matches();}
    /**
     * 检查是否是ppt
     * @param s
     * @return
     */
    public static boolean pptCheck(String s){return ppt_check.matcher(s).matches();}
     ...
     * @return
     */
    public static boolean imageCheck(String s){return image_check.matcher(s).matches();}
     ...
     * @return
     */
    public static boolean movieCheck(String s){return movie_check.matcher(s).matches();}
    /**
     * 检查是否音频
     * @param s
     * @return
     */
    public static boolean voiceCheck(String s){return voice_check.matcher(s).matches();}
     ...
     * @return
     */
    public static boolean docCheck(String s){return doc_check.matcher(s).matches();}
    /**
     * 检查是否DOC
     * @param s
     * @return
     */
    public static boolean excelCheck(String s){return excel_check.matcher(s).matches();}
    /**
     * 检查是否PDF
     * @param s
     * @return
     */
    public static boolean pdfCheck(String s){return pdf_check.matcher(s).matches();}
    ...
    /**
     * 判断是否为用户名帐号(规则如下：用户名由下划线或字母开头，由数字、字母、下划线、点、减号组成的4-32位字符)
     * @param username 用户名
     * @return boolean
     */
