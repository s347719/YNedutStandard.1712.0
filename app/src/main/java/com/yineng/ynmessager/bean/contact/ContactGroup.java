...
public class ContactGroup implements Serializable{
	...
	private int notifyMode = NOTIFYMODE_NOTIFY;  //该群的消息提醒方式
	public static final int NOTIFYMODE_NOTIFY = 1;  //接收并声音提醒
	public static final int NOTIFYMODE_SILENCE = 0;  //接收消息但不声音提醒
