                    ...
                    <%--<div ng-repeat="item in studentInfo.learnExperienceVOList">--%>
                        ...
                        <%--<div class="list" ng-show="item._isShow">--%>
                            <%--<div class="item item-input calender-icon touch-area">--%>
                                ...
                                <%--&lt;%&ndash;<input ng-model="item.beginTimeString" type="text"  ynui-datetimepicker="" range="{{'learnExperience'+$index}}" readonly>&ndash;%&gt;--%>
                            ...
                            <%--<div class="item item-input calender-icon touch-area">--%>
                                ...
                                <%--&lt;%&ndash;<input ng-model="item.endTimeString" type="text"  ynui-datetimepicker="" id="{{'learnExperience'+$index}}" readonly>&ndash;%&gt;--%>
...
<ion-footer-bar ng-show="!emptyInfo&&isSetData">
    <div class="text-center wd-100">
        <button class="button button-calm button-xlg" ng-click="submit()">
            提交
        </button>
    </div>
</ion-footer-bar>
